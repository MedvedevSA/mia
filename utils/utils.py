...
def include_module_route(app: FastAPI, module_path: Path, prefix:str = ''):
...
def include_routes(app: FastAPI, src_path: Path, prefix: str = ''):
    src_modules = [module for module in src_path.iterdir() if module.is_file()]
    for module in src_modules:
        include_module_route(app, module, prefix)
